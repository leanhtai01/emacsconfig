...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-pyright lsp-java csharp-mode vscode-dark-plus-theme smartparens web-mode rainbow-delimiters dap-mode emmet-mode sqlup-mode helm-xref helm-lsp lsp-treemacs which-key flycheck lsp-ui company lsp-mode treemacs nhexl-mode magit))
