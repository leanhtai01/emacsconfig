...
(custom-set-variables
 ...
 '(package-selected-packages
   '(counsel lsp-ivy lsp-pyright lsp-java csharp-mode vscode-dark-plus-theme web-mode rainbow-delimiters dap-mode emmet-mode sqlup-mode lsp-treemacs which-key flycheck lsp-ui company lsp-mode treemacs nhexl-mode magit))
